                            ...
                            {formFields.map((field, index) => {
                                ...
                                return (
                                    <motion.div
                                        ...
                                        placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 ${errors[field.name] ? 'border-red-500' : 'border-gray-500'
                                                    }`}
