        ...
        <div className="mt-2">
            <div className="flex space-x-1 mb-1">
                {[...Array(4)].map((_, i) => (
                    <motion.div
                        key={i}
                        className={`h-1 flex-1 rounded-full ${i < strength ? colors[strength - 1] : 'bg-gray-600'
                            }`}
                        initial={{ scaleX: 0 }}
            ...
            {password && (
                <motion.p
                    className={`text-xs ${strength === 4 ? 'text-green-400' :
                ...
                <div className="bg-gray-700/90 backdrop-blur-sm p-10 rounded-2xl shadow-xl w-full max-w-lg h-full border border-gray-600 relative overflow-hidden">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-1">
                        {formFields.map((field, index) => {
                            ...
                            return (
                                <motion.div
                                    ...
                                    placeholder-gray-400 focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200 ${errors[field.name] ? 'border-red-500' : 'border-gray-500'
                        ...
                        <motion.button
                            ...
                            focus:ring-4 focus:ring-green-200 transition-all duration-200 transform hover:scale-[1.02] cursor-pointer mt-4 relative overflow-hidden ${isLoading ? 'opacity-50 cursor-not-allowed' : ''
                                }`}
